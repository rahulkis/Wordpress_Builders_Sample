...
Kirki::add_field( 'envo_extra', array(
	...
	'output'	 => array(
		array(
			...
			'element'		 => '#theme-menu, #theme-menu.mm li:after, #theme-menu li a',
			'property'		 => 'color',
			'media_query'	 => '@media (max-width: 767px)',
		),
		array(
			'choice'		 => 'color_mainmenu',
			'element'		 => '#theme-menu.mm li:after, #theme-menu.mm:before',
		...
		array(
			'choice'	 => 'text_hover_mainmenu',
			'element'	 => '#theme-menu a:hover',
			'property'	 => 'color',
			'media_query'	 => '@media (max-width: 767px)',
		),
		array(
			'choice'	 => 'bg_text_hover_mainmenu',
			'element'	 => '#theme-menu li a:hover',
			'property'	 => 'background-color',
			'media_query'	 => '@media (max-width: 767px)',
		),
		array(
			'choice'	 => 'active_text_mainmenu',
			'element'	 => '#theme-menu li.active > a',
			'property'	 => 'color',
			'media_query'	 => '@media (max-width: 767px)',
		),
		array(
