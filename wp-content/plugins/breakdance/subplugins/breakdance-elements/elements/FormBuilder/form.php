...
class FormBuilder extends \Breakdance\Elements\Element
{
    ...
    static function contentControls()
    {
        ...
        $extraControls = [
            ...
            \Breakdance\Elements\control('csrf_disabled', 'Disable CSRF Protection', [
                'type' => 'toggle',
            ]),
            \Breakdance\Elements\control("csrf_disabled_warning", "CSRF Disabled", [
                ...
                'alertBoxOptions' => [
                    'style' => 'warning',
                    'content' => '<p>Disabling CSRF protection can be dangerous and you should understand the <a href="https://breakdance.com/documentation/other/security/" target="_blank">potential security implications</a>.</p>'
                ],
                'condition' => [
                    'path' => 'content.advanced.csrf_disabled',
                    'operand' => 'is set',
                    'value' => '',
                ],
            ])
